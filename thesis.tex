...
\CODtitle{Master's Thesis}          % Thesis type / Art der Arbeit (Master's Thesis, Diplomarbeit)
    ...
    {M\"unchen, 08 2019}          % Munich, Date / Muenchen, Datum
...
\CODrecht{Ha Nguyen}             % Your name / Name des Studenten
    {M\"unchen, 05.08.2019}         % Munich, Date / Muenchen, Datum
...
% arabic page numbering, starting with page number 1 / arabische Seitennummerierung beginnend mit Seite 1
	...
	\include{./tex_parts/0_introduction}
	\include{./tex_parts/1_preliminaries}
	\include{./tex_parts/2a_network_coding}
	\include{./tex_parts/2_generalized_combination_network}
    %\include{./tex_parts/3_network_as_matrix_channel}
    \include{./tex_parts/4_combinatorial_results}
    \include{./tex_parts/5_computational_results}
    \include{./tex_parts/6_conclusion}
...
% roman page numbering, starting with page number 1 (capitals)/ roemische Seitennummerierung beginnend mit Seite 1 (gross)
    ...
    \setcounter{page}{1}
    \pagenumbering{Roman}  
    \include{./tex_parts/7_appendices}   
