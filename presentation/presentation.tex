...
\frametitle{Motivation}
	...
	Vector network coding solutions can \textbf{significantly reduce the required alphabet size} compared to the optimal scalar linear solution for the same network. % General vector solutions for the Generalized Combination Network was not found. 
	\begin{figure}
